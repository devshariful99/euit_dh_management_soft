...
class ProjectController extends Controller
{
    ...
    {
        $data['projects'] = Project::with('creater', 'client', 'hosting', 'domain')->latest()->get();
        return view('admin.client_management.project.index', $data);
    }
    public function details($id): View
    {
        ...
        return view('admin.client_management.project.details', ['project' => $data]);
    }
    public function create(): View
    {
        $data['clients'] = Client::activated()->latest()->get();
        return view('admin.client_management.project.create', $data);
    }
    ...
    public function edit($id): View
    {
        ...
        return view('admin.client_management.project.edit', $data);
    }
