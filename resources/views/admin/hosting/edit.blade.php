                        ...
                        <div class="card-body">
                                ...
                                <select name="company_id" id="company_id" class="form-control">
                                    ...
                                    @foreach ($companies as $company)
                                        <option value="{{ $company->id }}"
                                            {{ $hosting->company_id == $company->id ? 'selected' : '' }}>
                                            {{ $company->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="url"
                                    ...
                                    id="admin_url" name="admin_url" value="{{ $hosting->admin_url }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    name="username" value="{{ $hosting->username }}" placeholder="Enter username">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    name="password" value="{{ $hosting->password }}" placeholder="Enter password">
