@extends('client.layouts.app', ['pageSlug' => 'domain'])
            ...
            <div class="card m-3">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="filter w-25">
                        <form action="{{ route('cp.domain.filter.list') }}" method="POST">
                            @csrf
                                ...
                                <div class="input-group">
                                    <select name="purchase_type" id="purchase_type" class="form-control">
                                        ...
                                        <option value="1" {{ old('purchase_type') == '1' ? 'selected' : '' }}>
                                            {{ __('Purchase From EuitSols') }}</option>
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '.view', function() {
                let id = $(this).data('id');
                let url = ("{{ route('cp.domain.details', ['id']) }}");
