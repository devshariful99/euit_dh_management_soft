...
@section('title', 'Edit Project Credentials')
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card m-3">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title">{{ __('Edit Project Credentials') }}</h3>
                    <div class="button_">
                ...
                <div class="card-body">
                    <form action="{{ route('cp.credential.edit', $credential->id) }}" method="POST">
                        @method('PUT')
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                    ...
                                    <select name="project" id="project" class="form-control">
                                        ...
                                        @foreach ($projects as $project)
                                            <option value="{{ $project->id }}"
                                                {{ $credential->project_id == $project->id ? 'selected' : '' }}>
                                                {{ $project->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title"
                                        value="{{ $credential->title }}" placeholder="Enter title">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="url" class="form-control" id="credential_url" name="url"
                                        value="{{ $credential->url }}" placeholder="Enter url">
                                    @include('alerts.feedback', [
                                        'field' => 'url',
                                    ])
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="email" class="form-control" id="credential_email" name="email"
                                        value="{{ $credential->email }}" placeholder="Enter email">
                                    @include('alerts.feedback', [
                                        'field' => 'email',
                                    ])
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="credential_username" name="username"
                                        value="{{ $credential->username }}" placeholder="Enter username">
                                    @include('alerts.feedback', [
                                        'field' => 'username',
                                    ])
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="credential_password" name="password"
                                        value="{{ $credential->password }}" placeholder="Enter password">
                                    @include('alerts.feedback', [
                                        'field' => 'password',
                                    ])
                                </div>
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="note" id="credential_note" class="form-control" placeholder="Enter note">{{ $credential->note }}</textarea>
                                    @include('alerts.feedback', [
                                        'field' => 'note',
                                    ])
                                </div>
